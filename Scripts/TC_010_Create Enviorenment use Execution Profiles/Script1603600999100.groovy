...
WebUI.setText(findTestObject('Write Test Case Manually/Page_OrangeHRM/input_txtUsername'), GlobalVariable.UserName)

WebUI.setText(findTestObject('Write Test Case Manually/Page_OrangeHRM/input_txtPassword'), GlobalVariable.PassWord)
